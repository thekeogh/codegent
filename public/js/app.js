...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(function () {
     ...
     * Products carousel
     */
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.CarouselProducts').slick({
        dots: false,
        infinite: true,
        speed: 500,
        fade: true,
     ...
     */
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.Primary__reveal').on('click', function () {
        if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()('body').hasClass('nav--on')) {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('body').removeClass('nav--on');
            menu_icon('menu');
        } else {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('body').addClass('nav--on');
            menu_icon();
        }
    });
    function menu_icon() {
        var icon = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'close';

        setTimeout(function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.Primary__reveal .material-icons').text(icon);
        }, 300);
    }
     ...
     */
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.Primary__more').on('click', function () {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('select[name="type"]').on('change', function () {
        ...
        if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val() == 'Agency' || __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val() == 'Products') {
            $cv.show();
        } else {
            $cv.hide();
        }
     ...
     * Open an overlay
     */
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.Overlayer').on('click', function (e) {
        e.preventDefault();
        var $overlay = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.Overlay');
        var $el = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);
        var href = $el.attr('href');
        var embed = href.indexOf('embed') >= 0 ? true : false;
        if (embed) __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.Overlay__container--iframe').attr('src', href);
        setTimeout(function () {
            $overlay.show();
        }, 500);
    });
     ...
     * Close an overlay
     */
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.Overlay__close').on('click', function (e) {
        e.preventDefault();
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.Overlay').hide();

        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.Overlay__container--iframe').attr('src', '#');
    });
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.Anchor').on('click', function (e) {
        e.preventDefault();
        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.smoothScroll({
            scrollTarget: __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('href')
        });
    });
});
